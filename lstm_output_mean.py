...
with tf.Session() as sess:
    ...
    for e in range(num_epoch):
        for i in range(num_batches):
            ...
            sess.run(train_step, feed_dict={input_x: x[:batch_size], input_y: labels_in_vec[:batch_size], seqlen: seqlen_x[:batch_size], dropout_keep_prob: 0.4,learning_rate:initial_learning_rate * (decay_rate ** e)})
